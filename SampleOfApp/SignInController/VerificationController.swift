...
class VerificationController: UIViewController, UITextViewDelegate, AEOTPTextFieldDelegate, UITextFieldDelegate {
...
//        let verificationCode = self.otpTxtFld.text
        ...
        let signupVC = sb.instantiateViewController(withIdentifier: "ViewController") as! ViewController
